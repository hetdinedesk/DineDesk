...
export default function PrivacyPage({ data, template }) {
  const legalDoc = data?.legalDocs?.find(doc => doc.type === 'privacy')
  const content = legalDoc?.content || 'Privacy Policy content not available.'
