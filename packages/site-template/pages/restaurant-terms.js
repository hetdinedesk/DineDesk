...
export default function RestaurantTermsPage({ data, template }) {
  const legalDoc = data?.legalDocs?.find(doc => doc.type === 'restaurant-terms')
  const content = legalDoc?.content || 'Restaurant Terms of Service content not available.'
    ...
    <CMSProvider data={data}>
      ...
      <main style={{ minHeight: '60vh', padding: '80px 20px 40px' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          <h1 style={{ fontSize: '2.5rem', fontWeight: 700, marginBottom: '2rem' }}>Restaurant Terms of Service</h1>
